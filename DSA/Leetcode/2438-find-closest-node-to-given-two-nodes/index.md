...
<h2><a href="https://leetcode.com/problems/find-closest-node-to-given-two-nodes" target = "_blank">2438. Find Closest Node to Given Two Nodes</a></h2><h3>Medium</h3><hr><p>You are given a <strong>directed</strong> graph of <code>n</code> nodes numbered from <code>0</code> to <code>n - 1</code>, where each node has <strong>at most one</strong> outgoing edge.</p>
