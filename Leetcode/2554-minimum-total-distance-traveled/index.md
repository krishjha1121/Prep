    ...
    public long minimumTotalDistance(List<Integer> robot, int[][] factory) {
        ...
        for (int j = n - 1; j >= 0; j--) {
            ...
            for (int i = m - 1; i >= 0; i--) {
                ...
                while (!qq.isEmpty() && qq.peekFirst().first > i + factory[j][1])
                    qq.pollFirst();
                while (!qq.isEmpty() && qq.peekLast().second >= dp[i][j + 1] - prefix)
                    qq.pollLast();
