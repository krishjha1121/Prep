<template>
  <div class="contrib-card">
    <!-- SVG golden outline -->
    <svg class="outline-svg" viewBox="0 0 350 500" preserveAspectRatio="none" aria-hidden="true" focusable="false">
      <defs>
      ...
      <rect x="2" y="2" width="346" height="496" rx="24" ry="24" fill="none"
            stroke="url(#goldGrad)" stroke-width="3" stroke-linejoin="round" class="outline-rect" />
    </svg>
...
const props = defineProps({
  ...
  description: { type: String, default: "In case you'd like to emphasize something very dramatically." },
...
.outer-glow {
    ...
    filter: blur(28px);
    opacity: 0.42;
    background: linear-gradient(22deg, rgb(217 217 217 / 41%), #9f90905e 94%, rgba(221, 132, 72, 0.06));
...
.avatar-wrap {
  ...
  place-items: center;
  margin-top: 6px;
  box-shadow: 0 6px 20px rgba(0,0,0,0.6), inset 0 0 0 6px rgba(255,255,255,0.02);
...
.link-btn:hover{ transform: translateY(-2px); background: rgba(255,255,255,0.06) }

/* small screen adjustments */
@media (max-width: 768px) {
  :root { --card-max-w: 300px; }
  .contrib-card { max-width: 300px; }

  .avatar-wrap { width: 110px; height: 110px; }
  .name { font-size: 26px; }
  .role { font-size: 14px; }
  .top { padding: 28px 18px 10px 18px; }
  .bottom { padding: 14px 18px 18px 18px; }
  .desc { font-size: 14px; }
}

/* very small */
@media (max-width: 420px) {
  :root { --card-max-w: 260px; }
  .contrib-card { max-width: 260px; }
