...
export default defineConfig({
	...
	themeConfig: {
			...
			"/DSA/": [
				{
					...
					collapsed: false,
					// items: [
					// 	{ text: "Easy Problems", link: "/DSA/Arrays/Easy/" },
					// 	{ text: "Medium Problems", link: "/DSA/Arrays/Medium/" },
					// 	{ text: "Hard Problems", link: "/DSA/Arrays/Hard/" },
					// ],
				},
				{
					text: "Algorithms",
					collapsed: false,
					// items: [
					// 	{ text: "Binary Search", link: "/DSA/Binary%20Search/" },
					// 	{ text: "Sorting", link: "/DSA/Sorting/" },
					// 	{ text: "Recursion", link: "/DSA/Recursion/" },
					// 	{ text: "Sliding Window", link: "/DSA/sliding%20window/" },
					// ],
				},
				{
					...
					collapsed: false,
					// items: [
					// 	{ text: "Trees", link: "/DSA/TREE/" },
					// 	{ text: "Graphs", link: "/DSA/GRAPH/" },
					// ],
				},
				{
					...
					collapsed: false,
					// items: [
					// 	{ text: "Dynamic Programming", link: "/DSA/Dynamic_programming/" },
					// 	{ text: "DP on Trees", link: "/DSA/DP_on_Tree/" },
					// 	{ text: "BFS", link: "/DSA/BFS/" },
					// 	{ text: "DFS", link: "/DSA/DFS/" },
					// ],
				},
			],
			...
			"/LLD/": [
				{
					...
					items: [
						...
						{ text: "UML Basics", link: "/LLD/01-fundamentals/03-uml-basics" },
					],
				},
				{
				...
				},
				{
					...
					items: [
						...
						{ text: "Observer", link: "/LLD/03-design-patterns/03-observer/" },
						{ text: "Strategy", link: "/LLD/03-design-patterns/04-strategy/" },
		...
		socialLinks: [{ icon: "github", link: "https://github.com/raj8664/Prep" }],
